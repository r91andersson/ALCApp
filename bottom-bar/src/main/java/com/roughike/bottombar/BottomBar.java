...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void selectTabAtPosition(int position, boolean animate) {
        ...
        try {
            ...
            Toast.makeText(getContext(),"Problem inside BottomBar.java while making animation of oldTab",Toast.LENGTH_LONG).show();
        }
        try {
            newTab.select(animate);
        } catch (Exception e) {
            Toast.makeText(getContext(),"Problem inside BottomBar.java while making animation of newTab",Toast.LENGTH_LONG).show();
        }
        ...
        try {
            ...
            Toast.makeText(getContext(),"Problem inside BottomBar.java while handling backgroundColor change",Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void updateSelectedTab(int newPosition) {
        ...
        int newTabId=0;
        try {
             newTabId = getTabAtPosition(newPosition).getId();
        }catch (Exception e){
            error=1;
        }
